...
public class FunctionLibrary {
	...
	public static WebDriver startBrowser() throws Throwable{
		...
		{
			System.setProperty("webdriver.chrome.driver", "F:\\All_Driver\\chromedriver-win64\\chromedriver.exe");
		...
		{
			Reporter.log("Broswer value  is not  matching", true);
		}
		return driver;
	}
	...
	public static void waitForElement(String LocatorType,String LocatorValues,String TestData){
		
		WebDriverWait  mywait = new WebDriverWait(driver,Duration.ofSeconds(Integer.parseInt(TestData)));
	    if(LocatorType.equalsIgnoreCase("id"))
	    {
	    	mywait.until(ExpectedConditions.visibilityOfElementLocated(By.id(LocatorValues)));
	    }
	    if(LocatorType.equalsIgnoreCase("name"))
	    {
	    	mywait.until(ExpectedConditions.visibilityOfElementLocated(By.name(LocatorValues)));
	    }
	    if(LocatorType.equalsIgnoreCase("xpath"))
	    {
	    	mywait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(LocatorValues)));
	    }
	    
	}
	//method for any  textBox 
	public static void typeAction(String LocatorType,String LocatorValues,String TestData)
	{
		if(LocatorType.equalsIgnoreCase("id")) {
			driver.findElement(By.id(LocatorValues)).clear();
			driver.findElement(By.id(LocatorValues)).sendKeys(TestData);
		}
		if(LocatorType.equalsIgnoreCase("xpath")) {
			driver.findElement(By.xpath(LocatorValues)).clear();
			driver.findElement(By.xpath(LocatorValues)).sendKeys(TestData);
		}
		if(LocatorType.equalsIgnoreCase("name")) {
			driver.findElement(By.name(LocatorValues)).clear();
			driver.findElement(By.name(LocatorValues)).sendKeys(TestData);
		}
	}
	//method for buttons,checkboxes,radiobuttons,links and images
	public static void  clickAction(String LocatorType,String LocatorValues)
	{
		if(LocatorType.equalsIgnoreCase("xpath")) {
			driver.findElement(By.xpath(LocatorValues)).click();
		}
		if(LocatorType.equalsIgnoreCase("id")) {
			driver.findElement(By.id(LocatorValues)).sendKeys(Keys.ENTER);
		}
		
	}
	//method for validate Title 
	public static void validateTiltle(String Expected_Title) {
